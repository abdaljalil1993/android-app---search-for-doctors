...
public class ManageUser extends AppCompatActivity {
    String url="https://scoutofsyria.000webhostapp.com/alluser1.php";
    ListView listView;
    //  myadapter mm;
            ...
            public void onResponse(String s) {
                try {
                    ...
                    for(int i=0;i<jr.length();i++)
                    {
                        ...
                        ManageUser.myadapter mm=new ManageUser.myadapter(listwithdata);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextChange(String newText) {
                ...
                ManageUser.myadapter m1=new ManageUser.myadapter(newlist);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if(x==R.id.h)
        {
            startActivity(new Intent(ManageUser.this,Admin.class));
        }

        if(x==R.id.exit)
        {
            startActivity(new Intent(ManageUser.this,Login.class));
        }
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
           ...
           /* img.setOnClickListener(new View.OnClickListener() {
            ...
            b.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent i=new Intent(ManageUser.this,Doctordetails.class);
