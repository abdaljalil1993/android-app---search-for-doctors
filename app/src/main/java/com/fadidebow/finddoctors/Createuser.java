...
public class Createuser extends AppCompatActivity {
    ...
    String url="https://scoutofsyria.000webhostapp.com/signup.php";
    @Override
            ...
            StringRequest tt=new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
                ...
                public void onResponse(String s) {
                    try {
                        ...
                        if(xr==true)
                        {
                            Toast.makeText(Createuser.this, "create acount successfully", Toast.LENGTH_SHORT).show();
                            name.setText("");
                            phone.setText("");
                            address.setText("");
                            uname.setText("");
                            ...
                            Toast.makeText(Createuser.this, "create acount failed", Toast.LENGTH_SHORT).show();
